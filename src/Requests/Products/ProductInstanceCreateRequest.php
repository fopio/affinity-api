...
class ProductInstanceCreateRequest extends AbstractRequest implements AbstractRequestInterface
{
    protected $request_array = [];

    protected $required_fields = ['SiteID', 'CLIID', 'ProductItemID', 'Quantity', 'StartDate'];
